 ...
 * @return {Function}
 */
module.exports = exports = function ( hostname, port ) {
    return function ( context ) {
        ...
        // 需要overwrite host，否则可能会服务器响应有问题
        // 但是如果服务器需要根据request host做一些特定的处理，可能就不需要这个处理了
        // 因此我们需要一个配置
        if (context.conf.proxyPreserveHost !== true) {
